...
export function ProductTabs({
  ...
  // Use product-specific care instructions if available, otherwise fall back to category defaults
  const defaultCare =
    careInstructions[category as keyof typeof careInstructions] ||
    careInstructions.default;

  const care = {
    light: careLight || defaultCare.light,
    water: careWater || defaultCare.water,
    temperature: careTemperature || defaultCare.temperature,
    fertilizer: careFertilizer || defaultCare.fertilizer,
  };
