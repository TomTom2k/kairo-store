...
import { HeroButtons } from "@/components/interactive/HeroButtons";
...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
            <span className="block text-foreground mb-2 animate-slide-in-left-fade" style={{ animationDelay: '0.1s' }}>
              Mang Thiên Nhiên
            </span>
            <span className="block gradient-animate bg-clip-text text-transparent animate-slide-in-right-fade" style={{ animationDelay: '0.2s' }}>
              Vào Không Gian Sống
            </span>
          </h1>

          {/* Decorative divider - Elegant & Interactive */}
          <div className="flex items-center justify-center gap-3 py-4 animate-fade-in" style={{ animationDelay: '0.15s' }}>
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-fade-in-scale glass-card rounded-2xl p-6 md:p-8" style={{ animationDelay: '0.25s' }}>
            Khám phá bộ sưu tập <strong className="text-primary">cây xanh tuyệt đẹp</strong> của chúng tôi. 
            Từ <em className="text-primary-light">cây cảnh văn phòng</em> đến <em className="text-primary-light">cây trang trí nội thất</em>, 
            chúng tôi có tất cả những gì bạn cần để tạo nên một ốc đảo xanh mát mắt trong không gian sống của bạn.
          </p>

          {/* CTA Buttons with Bounce Animation */}
          <div className="animate-bounce-in-up" style={{ animationDelay: '0.35s' }}>
            <HeroButtons />
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-8 pt-8 max-w-2xl mx-auto">
            ...
            >
              <div className="text-2xl md:text-3xl font-bold text-primary animate-pulse-subtle" itemProp="itemOffered">
                500+
              </div>
              <div className="text-xs md:text-sm text-muted-foreground">Loại Cây</div>
            </div>
            <div 
              className="space-y-2 glass-card rounded-xl p-4 md:p-6 animate-zoom-in-bounce hover:scale-105 transition-transform cursor-default" 
            ...
            >
              ...
              <div className="text-xs md:text-sm text-muted-foreground">Hài Lòng</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce hidden md:block" aria-label="Scroll down">
