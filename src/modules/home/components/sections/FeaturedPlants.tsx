...
const plants = [
  ...
  },
  {
    ...
    priceValue: 299000,
    rating: 4.9,
    image: "https://images.unsplash.com/photo-1597704374039-6e6d7f42c0b5?w=600&h=600&fit=crop",
...
export function FeaturedPlants() {
  return (
    ...
    >
      ...
      <ParallaxSection speed={0.8} className="absolute top-20 right-10 w-96 h-96 bg-primary/5 rounded-full blur-3xl" />
      <ParallaxSection speed={0.6} className="absolute bottom-40 left-20 w-80 h-80 bg-primary-light/5 rounded-full blur-3xl" />
          ...
          <ParallaxSection speed={0.3}>
            <ScrollReveal>
              <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed" itemProp="description">
                Những loại cây được chọn lọc kỹ càng, phù hợp với mọi không gian sống
              </p>
            </ScrollReveal>
          </ParallaxSection>
        </div>
